(function () {
    ...
    var time;
    var i;
    var fontList = ["购买成功", "回到首页", "3", "2", "1", "0"];
    ...
    function goIndex() {
        if (i % 2 == 1) {
            ...
            createText(fontList[i / 2].toUpperCase());
        }
        i++;
        if (i > 11) {
            explode();
    ...
    function initStages() {
        ...
        stage.canvas.height = window.innerHeight - 125;
    }

    function initForm() {
        form = document.getElementById('form');
        form.style.top = offsetY + 340 + 'px';
