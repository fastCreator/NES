...
(function () {
    ...
    app.directive('selectAddress', function ($rootScope, $http, $q, $compile) {
        var cityURL, delay, templateURL;
        delay = $q.defer();
        templateURL = '/javascripts/vendor/address/index.html';
        cityURL = '/javascripts/vendor/address/city.min.js';
